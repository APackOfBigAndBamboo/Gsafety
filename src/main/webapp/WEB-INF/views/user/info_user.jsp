    ...
    <div class="row">
        ...
        <div class="col-xs-10">
            <ul class="nav nav-tabs">
                <li role="presentation" class="active"><a href="/user/info?id=${user.id}">基本信息</a></li>
            ...
            <div class="tab-content">
                ...
                <form:form method="post" commandName="user">
                    ...
                    <div class="form-group">
                        <a class="btn btn-success pull-left" href="/deploy/list">确定</a>
                        <a class="btn btn-success pull-right" href="/deploy/list">返回</a>
                    </div>
                </form:form>
            </div>
        </div>
